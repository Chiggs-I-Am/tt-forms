...
export async function generateMetadata({
  ...
  return {
    title: form
      ? `Apply: ${form.name} · TT Forms Demo`
      : "Apply · TT Forms Demo",
  }
}

// Live 1:1 fill view. Loads the latest published version from Convex and
// renders every section and field from its definition, one section at a
// time. Answers stay in this browser only (foundation rule); server saving
// and submission arrive in #36/#37. Retired versions stop new applications;
// withdrawn versions explain why and stay closed.
