      ...
      <main className="[grid-area:main/fullbleed]">
        <section className="mx-auto w-[min(100%,992px)] @container/main [grid-area:main] lg:my-auto">
          <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-4">
            ...
            {/* Appointment */}
            <section>
              <div className="grid h-full w-full grid-rows-[auto,1fr,auto] place-items-start gap-2 overflow-hidden rounded-lg bg-gray-2 px-4 py-2 shadow-2">
                <Heading
                  as="h2"
                  weight="regular"
                ...
                <div className="grid h-full items-center gap-1">
                  <p className="text-sm">Come in and get the help you need.</p>
