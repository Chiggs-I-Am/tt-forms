      ...
      <Dialog as="div" className="relative z-50" onClose={ handleCancel }>
        ...
        */}
        ...
        <div className="fixed inset-0 grid place-items-center">
          ...
          <Dialog.Panel className="w-full space-y-4 p-6 max-w-sm rounded-xl shadow-md overflow-hidden transform transition-all bg-surface-light text-left align-middle">
            
            <Dialog.Title className="text-base font-bold">{ title }</Dialog.Title>
            
            <Dialog.Description>{ description }</Dialog.Description>
            
            <p className="text-sm">{ dialogBody }</p>
            ...
            <div className="inline-flex gap-4 w-full items-center justify-end">
              ...
              <button 
                ...
                className="h-10 px-6 rounded-full text-sm font-medium text-on-error-container-dark bg-error-container-dark">{ dialogConfirmText }</button>
            </div>
